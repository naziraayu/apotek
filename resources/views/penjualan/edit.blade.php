        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Edit Transaksi Penjualan</h5>
                </div>
                <ul class="breadcrumb">
            ...
            <div class="page-header-right ms-auto">
                <a href="{{ route('penjualan.show', $penjualan->id) }}" class="btn btn-light">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ $penjualan->no_nota }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Tanggal <span class="text-danger">*</span></label>
                                            <input type="date" name="tanggal_penjualan" class="form-control @error('tanggal_penjualan') is-invalid @enderror" value="{{ old('tanggal_penjualan', $penjualan->tanggal_penjualan->format('Y-m-d')) }}" required>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="tableObat">
                                            ...
                                            <tbody id="itemContainer">
                                                <!-- Items dari database akan ditambahkan di sini via JavaScript -->
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="diskon" class="form-control" id="inputDiskon" value="{{ old('diskon', $penjualan->diskon) }}" min="0" step="1000">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="metode_pembayaran" class="form-select @error('metode_pembayaran') is-invalid @enderror" required>
                                        ...
                                        <option value="e-wallet" {{ old('metode_pembayaran', $penjualan->metode_pembayaran) == 'e-wallet' ? 'selected' : '' }}>E-Wallet</option>
                                    </select>
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary btn-lg">
                                        <i class="feather-save me-2"></i>Update Transaksi
                                    </button>
                                    <a href="{{ route('penjualan.show', $penjualan->id) }}" class="btn btn-light">
    ...
    function addItemRow(detail = null) {
        ...
        const row = `
            <tr class="item-row" id="row-${itemCount}">
                    ...
                    <select name="obat_id[]" class="form-select form-select-sm select-obat" data-row="${itemCount}" required>
                        ...
                        ${obatData.map(obat => `
                            <option value="${obat.id}" 
                                ...
                                ${detail && detail.obat_id == obat.id ? 'selected' : ''}>
                ...
                <td>
                    <input type="number" name="harga_satuan[]" class="form-control form-control-sm harga-input" id="harga-${itemCount}" value="${detail ? detail.harga_satuan : ''}" readonly required>
                </td>
                <td>
                ...
                <td>
                    <input type="number" name="jumlah[]" class="form-control form-control-sm jumlah-input" id="jumlah-${itemCount}" value="${detail ? detail.jumlah : 1}" min="1" required data-row="${itemCount}">
                </td>
                <td>
        ...
        // Trigger change untuk update data
        if (detail) {
            $(`select[data-row="${itemCount}"]`).trigger('change');
        }
    }
