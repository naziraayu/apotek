        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Edit Kategori Obat</h5>
                </div>
                <ul class="breadcrumb">
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="card stretch stretch-full">
                        <div class="card-header">
                            <h5 class="card-title">Form Edit Kategori Obat</h5>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form action="{{ route('kategori-obat.update', $kategori->id) }}" method="POST" id="kategoriForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                                  ...
                                                  name="deskripsi" 
                                                  rows="4" 
                                                  placeholder="Masukkan deskripsi kategori obat (opsional)">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                    ...
                    <!-- Warning Card if has obat -->
                    @if($kategori->obat()->count() > 0)
                    <div class="card border-dashed border-warning bg-soft-warning">
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 fs-13">
                                        Kategori ini memiliki <strong>{{ $kategori->obat()->count() }} obat</strong> yang terkait. 
                                        Perubahan nama kategori akan mempengaruhi semua obat yang menggunakan kategori ini.
                                    </p>
                                </div>
                            </div>
                        </div>
